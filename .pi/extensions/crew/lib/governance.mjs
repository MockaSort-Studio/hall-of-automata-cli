export function governance({ topic, runId, rosterFile, outputPath }) {
  return `
## CREW RUN PROTOCOL
...
### 2. Create exactly one kickoff
Use extensions.crew_kickoff once. Its body contains: problem, verified references,
acceptance criteria, roster/assignments/dependencies, and open questions. Do not
