...
Keep messages concise and bounded to the assignment. A specialist remains resident for Lead deliveries and does not manage lifecycle. Only Main/Lifecycle removes SDK workers. Durable external evidence is supplied only by a separate adapter when needed.
